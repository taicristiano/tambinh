			...
			<?php 
				if(trim($logo_img) && $logo_img!=''){?> 
					...
					<div id="site-description">
						<p id="site-description-p" style="max-width: 375px; margin-top: -20px;text-align: right;">Khi tình yêu bắt đầu...</p>
					</div>
					<?php	
				}								
				else {
				...
				<div id="site-description">
						<p id="site-description-p">Khi tình yêu bắt đầu...</p>
				</div>
			<?php } ?>
			</div>
		</a>
...
foreach ($weddings_home_page->options_homepage as $value)
 ...
 $image_link=get_theme_mod('web_busines_image_link',
 	  get_template_directory_uri('template_url').'/images/slider/01.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/02.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/03.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/04.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/05.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/06.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/07.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/08.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/09.jpg'.';;;;'
 	. get_template_directory_uri('template_url').'/images/slider/10.jpg');
 ...
 <?php	
	...
	$slideshow_height = esc_html(get_theme_mod('ct_slider_height','560'));
  if(is_home()){
 ?>
 <style>
